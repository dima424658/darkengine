...
int gr_font_string_width (grs_font *f, const char *s)
{
...
int gr_font_string_height (grs_font *f, const char *s)
{
   short h;                   /* height */
...
void gr_font_string_size (grs_font *f, const char *s, short *w, short *h)
{
   short *offset_tab;         /* table of character offsets */
   short offset;              /* offset of current character */
   short w_lin=0;             /* current line's width so far */
...
int gr_font_string_nwidth (grs_font *f, const char *s, int n)
{
   short *offset_tab;         /* table of character offsets */
   short offset;              /* offset of current character */
   short w_lin=0;             /* current line's width so far */
...
int gr_font_string_nheight (grs_font *f, const char *s, int n)
{
   short h;                 /* height */
   char c;                  /* current character */
