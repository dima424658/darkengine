...
typedef DWORD DPlayObjectFlags;
 ...
 *
 ****************************************************************************/
typedef DWORD DPLCONNECTIONFlags;
 ...
 *
 ****************************************************************************/
typedef DWORD EnumConnectionsFlags;
...
typedef DWORD CreatePlayerFlags;
...
typedef DWORD CreateGroupFlags;
...
typedef DWORD EnumSessionsFlags;
 ...
 *
 ****************************************************************************/
typedef DWORD GetMessageQueueFlags;
...
typedef DWORD DirectPlayMessages;
...
interface IDirectPlay2 : IUnknown
{
    ...
    DPRESULT GetCaps( _Out_ LPDPCAPS lpDPCaps, GetCapsFlags dwFlags);
    DPRESULT GetGroupData( DPID idGroup, _Out_ LPVOID lpData, _Out_ LPDWORD lpdwDataSize, GetDataFlags dwFlags);
    DPRESULT GetGroupName( DPID idGroup, _Out_ LPVOID lpData, _Out_ LPDWORD lpdwDataSize);
    DPRESULT GetMessageCount( DPID idPlayer, _Out_ LPDWORD lpdwCount );
    DPRESULT GetPlayerAddress( DPID idPlayer, _Out_ LPVOID lpData, _Out_ LPDWORD lpdwDataSize );
    DPRESULT GetPlayerCaps( DPID idPlayer, _Out_ LPDPCAPS lpPlayerCaps , GetCapsFlags dwFlags);
    DPRESULT GetPlayerData( DPID idPlayerD, _Out_ LPVOID lpData, _Out_ LPDWORD lpdwDataSize, GetDataFlags dwFlags);
    DPRESULT GetPlayerName( DPID idPlayerD, _Out_ LPVOID lpData, _Out_ LPDWORD lpdwDataSize );
    DPRESULT GetSessionDesc( _Out_ LPVOID lpData, _Out_ LPDWORD lpdwDataSize );
    DPRESULT Initialize( LPGUID lpGUID );
    DPRESULT Open( LPDPSESSIONDESC2 lpsd , OpenFlags dwFlags);
    DPRESULT Receive( LPDPID lpidFrom, LPDPID lpidTo, ReceiveFlags dwFlags, _Out_ LPVOID lpData, _Out_ LPDWORD lpdwDataSize );
...
interface IDirectPlay3 : IDirectPlay2
{
	...
	DPRESULT GetGroupConnectionSettings(DWORD dwFlags, DPID idGroup, _Out_ LPVOID lpData, _Out_ LPDWORD dwDataSize);
    ...
    DPRESULT GetGroupFlags(DPID idGroup, _Out_ CreateGroupFlags * lpdwFlags );
    DPRESULT GetGroupParent(DPID idGroup, _Out_ LPDPID lpidParentGroup);
    DPRESULT GetPlayerAccount(DPID idPlayer, DWORD dwFlags, _Out_ LPVOID lpData , _Out_ LPDWORD lpdwDataSize );
    DPRESULT GetPlayerFlags(DPID idPlayer,  _Out_ LPDWORD lpdwDataSize );
};
...
interface IDirectPlay4 : IDirectPlay3
{
    ...
    DPRESULT GetGroupOwner( DPID idGroup, _Out_  LPDPID lpidOwner );
    ...
    DPRESULT GetMessageQueue(DPID idFrom, DPID idTo, GetMessageQueueFlags dwFlags, _Out_ LPDWORD lpdwNumMsgs, _Out_ LPDWORD lpdwNumBytes );
...
DPRESULT DirectPlayCreate( LPGUID lpGUID, _Out_ LPDIRECTPLAY *lplpDP, IUnknown *pUnk);