...
tmap_setup_func* flat8_ulmap_setup_func[BMT_TYPES * FILL_TYPES * BMF_TYPES] =
{
	[MAKE_INDEX(BMT_FLAT8, FILL_NORM, BMF_TRANS)] =		gen_flat8_ulmap_setup,
	[MAKE_INDEX(BMT_FLAT8, FILL_NORM, BMF_OPAQUE)] =	opaque_8to8_setup,
	[MAKE_INDEX(BMT_FLAT8, FILL_CLUT, BMF_TRANS)] =		gen_flat8_ulmap_setup,
	[MAKE_INDEX(BMT_FLAT8, FILL_CLUT, BMF_OPAQUE)] =	opaque_clut_8to8_setup,
	...
	[MAKE_INDEX(BMT_FLAT8, FILL_BLEND, BMF_TRANS)] =	translucent_8to8_setup,
