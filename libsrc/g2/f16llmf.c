...
void (*flat16_lit_ulmap_setup_func[])() =
{
	[MAKE_INDEX(BMT_FLAT8 ,FILL_NORM ,BMF_TRANS)] =		gen_flat8_lit_ulmap_setup,
	[MAKE_INDEX(BMT_FLAT8 ,FILL_NORM ,BMF_OPAQUE)] =	opaque_lit_8to16_setup,
	...
	[MAKE_INDEX(BMT_FLAT16 ,FILL_NORM ,BMF_TRANS)] =	gen_flat16_lit_ulmap_setup,
	[MAKE_INDEX(BMT_FLAT16 ,FILL_NORM ,BMF_OPAQUE)] =	gen_flat16_lit_ulmap_setup,
	[MAKE_INDEX(BMT_FLAT16 ,FILL_CLUT ,BMF_TRANS)] =	gen_flat16_lit_ulmap_setup,
	[MAKE_INDEX(BMT_FLAT16 ,FILL_CLUT ,BMF_OPAQUE)] =	gen_flat16_lit_ulmap_setup,
	[MAKE_INDEX(BMT_FLAT16 ,FILL_SOLID ,BMF_TRANS)] =	gen_flat16_lit_ulmap_setup,
	[MAKE_INDEX(BMT_FLAT16 ,FILL_SOLID ,BMF_OPAQUE)] =	gen_flat16_lit_ulmap_setup,
	[MAKE_INDEX(BMT_FLAT16 ,FILL_BLEND ,BMF_TRANS)] =	gen_flat16_lit_ulmap_setup,
	[MAKE_INDEX(BMT_FLAT16 ,FILL_BLEND ,BMF_OPAQUE)] =	gen_flat16_lit_ulmap_setup,
	[MAKE_INDEX(BMT_FLAT16 ,FILL_XOR ,BMF_TRANS)] =		gen_flat16_lit_ulmap_setup,
	[MAKE_INDEX(BMT_FLAT16 ,FILL_XOR ,BMF_OPAQUE)] =	gen_flat16_lit_ulmap_setup,
