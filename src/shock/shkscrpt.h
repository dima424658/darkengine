...
DECLARE_SCRIPT_SERVICE(ShockGame, 0x108)
{
   ...
   STDMETHOD(Replicator)(const object& RepObj) PURE;
   ...
   STDMETHOD_(BOOL,HasImplant)(const object& Who, int implant) PURE;
   ...
   STDMETHOD(GrantPsiPower)(const object& who, int which) PURE;

   STDMETHOD_(BOOL, ResearchConsume)(const object& Obj) PURE;
